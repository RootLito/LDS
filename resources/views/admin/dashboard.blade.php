...
<div class="w-full h-full flex flex-col p-10 overflow-y-auto">
    ...
    <div class="flex-1 grid gap-6 mt-10
        ...
        <div class="flex flex-col bg-white rounded p-6 md:col-span-3 h-[520px] relative">
            <p class="text-gray-500 text-lg">Monthly Training Distribution</p>
            <div class="flex-1">
                <canvas id="monthlyTrainingChart" class="w-full h-full"></canvas>
            </div>
        </div>


        <div class="bg-white rounded p-6 md:col-span-1 h-[520px] overflow-y-auto">
            <p class="text-gray-500 text-lg mb-6">Training-Based Ranking</p>

        ...
        <div class="px-10">
            <form method="GET" action="{{ route('admin.trainings') }}"
                ...
                <select name="applicable_for" class="border border-gray-300 px-3 py-2 rounded w-48">
                    ...
                    <option value="per" @selected(request('applicable_for')=='per' )>Permanent</option>
                    <option value="jocos" @selected(request('applicable_for')=='jocos' )>Jocos</option>
                    <option value="per_and_jocos" @selected(request('applicable_for')=='per_and_jocos' )>
                        Permanent and Jocos
                    </option>
                </select>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="{{ $loop->last ? '' : 'border-b border-gray-200' }} hover:bg-gray-50">
                            ...
                            $badgeLabel = $badgeLabels[$training->applicable_for]
                            ...
                            <td class="p-4">
                                <div x-data="{ openDetails: false, openDelete: false, openEdit: false }"
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 text-sm">
                                                ...
                                                <div class="bg-gray-50 border border-gray-200 rounded-xl p-5 space-y-3">
                                                    <div class="flex justify-between">
                                                        ...
                                                        <span class="font-medium ">{{ ucfirst($training->status)
                                                            }}</span>
                                                    </div>
                                                ...
                                                <div class="bg-gray-50 border border-gray-200 rounded-xl p-5 space-y-3">
                                                    ...
                                                    <div class="flex justify-between">
                                                        <span
                                                            class="font-semibold text-gray-600 flex items-center gap-2">
                                                            <i class="fa-solid fa-file-lines"></i>HRDC Resolution No.
                                                        </span>
                                            ...
                                            <div>
                                                <h3
                                                    ...
                                                    <span class="text-xl text-gray-500">({{
                                                        $training->number_of_nominees }})</span>
                                                </h3>

                                                <div class="overflow-auto max-h-72 border border-gray-200 rounded-xl">
                                        ...
                                        <div @click.away="openEdit = false"
                                            ...
                                            <form action="{{ route('admin.trainings.update', $training->id) }}"
                                                ...
                                                <div class="mb-4">
                                                    <label class="block text-sm font-medium text-gray-700">Title</label>
                                                    <textarea name="title" required
                                                        class="w-full h-[100px] resize-none px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ $training->title }}</textarea>
                                                </div>

                                                <!-- Applicable For -->
                                                <div class="mb-4">
                                                    <label class="block text-sm font-medium text-gray-700">Applicable
                                                        for</label>
                                                    <select name="applicable_for"
                                                        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none">
                                                        <option value="">Select</option>
                                                        <option value="permanent" @selected($training->
                                                            applicable_for=='permanent')>Permanent</option>
                                                        <option value="jocos" @selected($training->
                                                            applicable_for=='jocos')>Jocos</option>
                                                        <option value="permanent_and_jocos" @selected($training->
                                                            applicable_for=='permanent_and_jocos')>
                                                            Permanent and Jocos
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="status" required
                                                        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none">
                                                        <option value="pending" @selected($training->
                                                            status=='pending')>Pending</option>
                                                        <option value="attended" @selected($training->
                                                            status=='attended')>Attended</option>
                                                        <option value="cancelled" @selected($training->
                                                            status=='cancelled')>Cancelled</option>
                                                    </select>
                                                </div>
                                                ...
                                                <!-- Conducted By -->
                                                <div class="mb-4">
                                                    <label class="block text-sm font-medium text-gray-700">Conducted
                                                        by</label>
                                                ...
                                                <!-- Charging of Funds -->
                                                <div class="mb-4">
                                                    <label class="block text-sm font-medium text-gray-700">Charging of
                                                        Funds</label>
                                                    <input type="text" name="charging_of_funds"
